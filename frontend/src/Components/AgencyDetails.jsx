    ...
    <Row className="text-center">
      ...
      >
          ...
          <Container>
            ...
            <Row className="mt-5">
              ...
              <Col xs={6} sm={6} md={6} lg={6} className="p-1">
                ...
                <h6 className="text-center my-4">x</h6>
              </Col>
            </Row>
        ...
        {state.userProfile.sellerListings.map((listing) => {
					return (
						<Card key={listing.id} className='my-3 listing-box' style={{ display: 'flex' }}>
                            <Card.Img className='p-3 listing-img' variant="top" src={listing.picture1 ? listing.picture1 : 'https://res.cloudinary.com/dsq1kzjdy/image/upload/v1662651727/media/No-Image-Placeholder.svg_bgopvn.png'} />
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                    Price: {listing.property_status === "Sale"
										? ` €${listing.price
												.toString()
												.replace(/\B(?=(\d{3})+(?!\d))/g, ",")}`
										: `€${listing.price
